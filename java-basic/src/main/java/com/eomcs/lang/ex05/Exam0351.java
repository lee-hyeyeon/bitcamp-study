...
public class Exam0351 {
  public static void main(String[] args) {
    ...
    System.out.println(57 & 1); // 0x1이 1과 같으므로, 짝수 인지 홀수 인지 구할 때
    // & 연산자를 사용하며 맨 끝자리 값이 1인지 0인지 확인해서 홀짝을 구한다
    // 어떤값에 and : 둘다 1일 때만 1!!!
    // % 연산은 나누기 연산을 수행해야 한다.
    ...
    // and(&) 연산자는 1이 하나라도 있으면 1이기 때문에
    // 맨 끝 비트만 확인하면 저 수가 짝수인지 홀수인지 바로 확인 가능하다.
    //
    //    0011 0101 (53)
    //  & 0000 0001
    // --------------
